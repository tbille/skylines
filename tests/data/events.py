...
def flight_comment(actor, flight, flight_comment, **kwargs):
    return Event(
        ...
        time=datetime(2017, 2, 11, 12, 34, 56),
        actor=actor,
        flight=flight,
...
def flight(actor, flight, **kwargs):
    return Event(
        ...
        time=datetime(2017, 2, 12, 12, 34, 56),
        actor=actor,
        flight=flight,
    ).apply_kwargs(kwargs)
...
def follower(actor, user, **kwargs):
    return Event(
        ...
        time=datetime(2017, 2, 13, 12, 34, 56),
        actor=actor,
        user=user,
    ).apply_kwargs(kwargs)
...
def new_user(actor, **kwargs):
    return Event(
        ...
        time=datetime(2017, 2, 14, 12, 34, 56),
        actor=actor,
    ).apply_kwargs(kwargs)
...
def club_join(actor, club, **kwargs):
    return Event(
        ...
        time=datetime(2017, 2, 15, 12, 34, 56),
        actor=actor,
        club=club,
    ).apply_kwargs(kwargs)
